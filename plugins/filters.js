...
const array = ['Ayin','Ayinu','Bgm','Bot','Bye','Good night','Hello','Hi','Neymar','Pm','Sed','alive','assist','ban','bgm','bot','converting','fake','fork','fuck','music','myre','njan','number','oombi','owner','poda','raganork','remove','reply','sed','subscribe','xxxtentation']
array.map( async (a) => {
